...
import ForceTheme from '@/app/purchase/force-theme';
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        ...
        title: locale === 'vi' ? 'Xác Nhận Thanh Toán' : 'Payment Confirmation',
        description: locale === 'vi'
            ? 'Xác nhận trạng thái thanh toán giao dịch của bạn.'
            : 'Confirm your transaction payment status.',
    };
}
