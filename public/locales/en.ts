...
export const en: TranslationsStructure = {
    ...
    account: {
        ...
        dashboard: {
            greeting: 'Hello,',
            overview: 'Overview',
            manageDescription: 'Manage your account in the Chào Market ecosystem',
            ...
            servicesDesc: 'View all Chào Market services',
        ...
        servicesPage: {
            ...
            description: 'All services in the Chào Market ecosystem',
            yourServices: 'Your Products & Services',
            allServicesLinked: 'All services in the Chào Market ecosystem are linked with your account.',
