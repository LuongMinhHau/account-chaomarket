...
export const vi: TranslationsStructure = {
    ...
    sidebar: {
        ...
        chaoNews: 'Chào News',
        brandGoal: 'Quản Lý Tài Khoản Của Bạn',
    },
    notifications: {
    ...
    account: {
        ...
        dashboard: {
            greeting: 'Xin chào,',
            overview: 'Tổng quan',
            manageDescription: 'Quản lý tài khoản của bạn trong hệ sinh thái Chào Market',
            ...
            servicesDesc: 'Xem tất cả dịch vụ Chào Market',
        ...
        servicesPage: {
            ...
            description: 'Tất cả dịch vụ trong hệ sinh thái Chào Market',
            yourServices: 'Sản Phẩm & Dịch Vụ Của Bạn',
            allServicesLinked: 'Tất cả dịch vụ trong hệ sinh thái Chào Market được liên kết với tài khoản của bạn.',
